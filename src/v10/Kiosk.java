...
import v10.helper.IOHandler;
import v10.repository.MenuRepository;
import v10.utils.KioskUtils;
...
public class Kiosk {
    ...
    private final MenuRepository<Map<Integer, Menu>> menuRepository;
    ...
    private void printMenuSelectMessage() {
        ...
        Map<Integer, Menu> menus = menuRepository.findAll();

        for(int i = 1; i <= menus.size(); i++) {
            ioHandler.writeOutput((i) +") " + menus.get(i).displayDetails());
        }
    }
